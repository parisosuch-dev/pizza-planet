...
export default function Hero() {
    ...
    return (
        <div className="flex flex-col sm:flex-row text-center items-center sm:text-left sm:justify-between space-y-8 sm:space-y-0">
            ...
            <img
                className="w-[345px] h-[234px] sm:w-[800px] sm:h-[467px] rounded-lg"
                src={heroImage.src}
            />
        </div >
    )
